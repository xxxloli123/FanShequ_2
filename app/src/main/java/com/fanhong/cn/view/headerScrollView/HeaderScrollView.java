package com.fanhong.cn.view.headerScrollView;
...
public class HeaderScrollView extends LinearLayout {
    ...
    public HeaderScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CTTourHeaderScrollView2);
        topOffset = a.getDimensionPixelSize(R.styleable.CTTourHeaderScrollView2_top_offset, topOffset);
        a.recycle();
